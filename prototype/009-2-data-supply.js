...
window.__EVA_SUPPLY_MEMBER_DEMO = {
  ...
  messages:[
    ...
    {kind:'text',senderId:'u-wangyilin',time:'10:02',text:'先将分析报告共享给项目成员。是否对供应商承诺执行，由负责人确认。'},
...
(function(root){
  ...
  const scenarios={
    prod:[
      ...
      ['contracts','采购合同到期提醒','每周一 10:00','检查未来 30 天到期合同，整理续签节点及需要人工确认的商务事项。','supply-7','本轮 4 份合同进入续签窗口，已关联续签检查任务，未向供应商发送承诺。','已核对到期日期与负责人员，未发现新增逾期。']
    ],
    'drive-design':[
