...
window.__EVA_SUPPLY_CHAIN_DEMO.issues.push(
  ...
  {...window.__EVA_SUPPLY_CHAIN_DEMO.issues[0],id:'supply-9',number:9,identifier:'SC-109',position:9,parent_issue_id:'supply-1',title:'汇总行政办公采购需求',status:'done',priority:'medium',assignee_type:'member',assignee_id:'u-linxiao',assignee_name:'林晓',description:'核对办公设备数量、预算和最晚到货日期，形成行政采购需求清单。'},
  {...window.__EVA_SUPPLY_CHAIN_DEMO.issues[0],id:'supply-10',number:10,identifier:'SC-110',position:10,parent_issue_id:'supply-1',title:'核对 IT 设备预算与交付批次',status:'in_progress',priority:'high',assignee_type:'agent',assignee_id:'ag-supply-procurement',assignee_name:'间接采购专家',description:'按设备类型核对预算、数量和交付批次，标记仍需业务确认的缺口。'},
  {...window.__EVA_SUPPLY_CHAIN_DEMO.issues[0],id:'supply-11',number:11,identifier:'SC-111',position:11,parent_issue_id:'supply-1',title:'确认设备维保续约计划',status:'todo',priority:'medium',assignee_type:'agent',assignee_id:'ag-supply-contract',assignee_name:'供应链合同管理专家',description:'汇总维保范围、续约期限和预算口径，确认进入询价前的必要条件。'},
  {...window.__EVA_SUPPLY_CHAIN_DEMO.issues[0],id:'supply-12',number:12,identifier:'SC-112',position:12,parent_issue_id:'supply-11',title:'补齐维保预算与到期清单',status:'todo',priority:'medium',assignee_type:'member',assignee_id:'u-zhouyuan',assignee_name:'周远',description:'逐项补齐设备维保预算、合同到期日和业务负责人，供续约计划复核。'}
);
