(function(root){
  ...
  root.EvaPickerPreview={create({React:R,Button,Select,Modal,Input,Tag,Checkbox,Radio},store){
    ...
    const modes={
      add:{label:'添加联系人',title:'添加项目成员',hint:'选择要添加到供应链运营协同的成员。',kinds:['human'],submit:'确认添加'},
      ...
      transfer:{label:'转让职责',title:'转让项目负责人',hint:'选择项目内另一位联系人接任负责人。',kinds:['human'],single:true,submit:'确认转让'}
    };
    function SelectionBody({items,selected,onChange,single,showProjectFilter,humanHint,humanLabel='联系人',emptyTitle='暂无可选成员',emptyDescription='当前范围内没有可选择的联系人或分身。',renderIdentity,search,searchPlaceholder='搜索可选成员',searchLabel='搜索可选成员',searchIcon,noResultsText='没有匹配的成员'}){
