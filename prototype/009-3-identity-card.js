 ...
 function IdentityCard({identity,onClose,startAvatarEditing}){
  ...
  return h(R.Fragment,null,id&&(popupHost||!root.document)&&h(Modal,{
   ...
   avatarEditing&&profile&&canEditAvatar?h('div',{className:'eva-avatar-editor__host'},
     h(AvatarEditor,{current:profile.appearance?(profile.kind==='clone'?profile.appearance.ownerAvatar:profile.appearance.avatar):profile.avatar,initialImage:cropImage,onCancel:closeEditor,onSave:finishAvatar}),
