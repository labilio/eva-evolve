...
function EvaAITeamPage() {
  ...
  function identityItem(i){
    ...
    const expanded=collapsed[i.id]===false, emptyPersona=i.role==='persona'&&sessions.length===0, hasUnread=sessions.some(item=>item.unreadCount>0), abnormal=i.status==='offline'||(i.role==='persona'&&i.syncStatus!=='synced');
    return h('section',{className:'eva-ai-team__identity',key:i.id},
      h('div',{className:'eva-ai-team__identity-heading'},
        h('button',{type:'button',className:'eva-ai-team__identity-button','aria-expanded':expanded,'aria-controls':'ai-sessions-'+i.id,onClick:()=>{setCollapsed(value=>({...value,[i.id]:emptyPersona?false:expanded}));if(emptyPersona)choose(i.id,null);}},
  ...
  return h('div',{className:'eva-ai-team'},
    ...
    cut('const FilePreviewHeader=({file:rt',
      'const EvaFilePreviewEnterFullscreenIcon=createLucideIcon("Maximize2",[["path",{d:"M15 3h6v6",key:"file-preview-expand-1"}],["path",{d:"m21 3-7 7",key:"file-preview-expand-2"}],["path",{d:"m3 21 7-7",key:"file-preview-expand-3"}],["path",{d:"M9 21H3v-6",key:"file-preview-expand-4"}]]),EvaFilePreviewExitFullscreenIcon=createLucideIcon("Minimize2",[["polyline",{points:"4 14 10 14 10 20",key:"file-preview-collapse-1"}],["polyline",{points:"20 10 14 10 14 4",key:"file-preview-collapse-2"}],["line",{x1:"14",x2:"21",y1:"10",y2:"3",key:"file-preview-collapse-3"}],["line",{x1:"3",x2:"10",y1:"21",y2:"14",key:"file-preview-collapse-4"}]]);const FilePreviewHeader=({file:rt', '文件预览全屏使用 Lucide 图标');
