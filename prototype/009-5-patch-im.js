...
function EvaAITeamPage() {
  ...
  function identityItem(i){
    ...
    const expanded=collapsed[i.id]===false, hasUnread=sessions.some(item=>item.unreadCount>0), abnormal=i.status==='offline'||(i.role==='persona'&&i.syncStatus!=='synced');
