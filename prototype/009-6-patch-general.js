...
`;
    ...
    source=root.__evaCut(source,
      ...
      'render:Qt,trigger:"click",position:"bottomLeft",getPopupContainer:evaTaskPopupContainer',
      '选人弹层限制在标题栏下方内容区');
