...
EvaNavIcon=(rt,ct,ut)=>React.createElement("span",{className:"eva-nav-icon"},rt,ct&&React.createElement("span",{className:"eva-nav-icon__unread",role:"status","aria-label":ut||"有未读消息",title:"有未读消息"})),EvaMessagesNavEntry=rt=>{const ct=evaMembers().store;reactExports.useSyncExternalStore(ct.subscribe,ct.getSnapshot,ct.getSnapshot);const ut=evaMessagesHasUnread(ct),pt=React.createElement(EvaMessageCircleIcon,{size:16,strokeWidth:1.8,className:"block leading-none"}),gt=EvaNavIcon(pt,ut);return React.createElement(SiderEvaStub,{label:rt.label,isMobile:rt.isMobile,collapsed:rt.isMobile&&rt.collapsed,siderTooltipProps:rt.siderTooltipProps,isActive:rt.isActive,onClick:rt.onClick,icon:gt})},
