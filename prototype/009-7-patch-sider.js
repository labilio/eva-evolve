...
`;
        ...
        source = root.__evaCut(source, 'React.createElement("span",{className:"eva-logout",title:"退出登录",onClick:Ft=>{Ft.stopPropagation(),xt()}},"⏻")', 'React.createElement("button",{type:"button",className:"eva-logout",title:"退出登录","aria-label":"退出登录",onClick:Ft=>{Ft.stopPropagation(),xt()}},React.createElement(EvaPowerIcon,{size:16,strokeWidth:1.8}))', '展开侧栏退出复用 Lucide');
        source = root.__evaCut(source, 'React.createElement(CloseOne$7,{theme:"outline",size:"16",fill:iconColors.primary,className:"block leading-none",style:{lineHeight:0}})', 'React.createElement(EvaPowerIcon,{size:16,strokeWidth:1.8,className:"block leading-none"})', '收起侧栏退出复用 Lucide');
