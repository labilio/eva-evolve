  ...
  root.__evaPatch('sidebar', function (source) {
        ...
        var sidebarWidthReplacements = [
          ...
          [
            ...
            'Layout$1=({sider:rt,onSessionClick:ct})=>{const[ut,pt]=reactExports.useState(!0),[mt,gt]=reactExports.useState(!1),'
          ],
          [
...
EvaMessageCircleIcon=createLucideIcon("message-circle",[["path",{d:"M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719",key:"message-circle"}]]),EvaMoreIcon=createLucideIcon("ellipsis",[["circle",{cx:12,cy:12,r:1,key:"a"}],["circle",{cx:19,cy:12,r:1,key:"b"}],["circle",{cx:5,cy:12,r:1,key:"c"}]]),EvaLogOutIcon=createLucideIcon("log-out",[["path",{d:"m16 17 5-5-5-5",key:"a"}],["path",{d:"M21 12H9",key:"b"}],["path",{d:"M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4",key:"c"}]]),EvaCameraIcon=createLucideIcon("camera",[["path",{d:"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z",key:"1o9zid"}],["circle",{cx:"12",cy:"13",r:"3",key:"1jzowv"}]]),evaNavFlyout={current:null,listeners:new Set,getSnapshot:()=>evaNavFlyout.current,subscribe:fn=>(evaNavFlyout.listeners.add(fn),()=>evaNavFlyout.listeners.delete(fn)),emit:()=>evaNavFlyout.listeners.forEach(fn=>fn()),open:id=>{evaNavFlyout.current!==id&&(evaNavFlyout.current=id,evaNavFlyout.emit())},close:id=>{evaNavFlyout.current===id&&(evaNavFlyout.current=null,evaNavFlyout.emit())}},SiderFooter=props=>{const[visible,setVisible]=reactExports.useState(false),[avatarOpen,setAvatarOpen]=reactExports.useState(false),menuOpen=reactExports.useSyncExternalStore(evaNavFlyout.subscribe,evaNavFlyout.getSnapshot,evaNavFlyout.getSnapshot)==="account",navigate=useNavigate(),auth=useAuth(),store=evaMembers().store;reactExports.useSyncExternalStore(store.subscribe,store.getSnapshot,store.getSnapshot);const actorId=store.snapshot().actorId,person=store.person(actorId),name=person?.name||actorId;return React.createElement(React.Fragment,null,React.createElement("footer",{className:classNames("eva-sider-footer",props.collapsed&&"is-collapsed")},React.createElement(Dropdown,{trigger:"hover",mouseEnterDelay:60,mouseLeaveDelay:160,visible:menuOpen,onVisibleChange:vt=>{vt?evaNavFlyout.open("account"):evaNavFlyout.close("account")},position:props.collapsed?"rightBottom":"top",className:"eva-account-menu",render:React.createElement(Dropdown.Menu,null,React.createElement(Dropdown.Item,{className:"eva-account-menu__item",onClick:()=>{evaNavFlyout.close("account");setAvatarOpen(true)}},React.createElement(EvaCameraIcon,{size:16,className:"eva-account-menu__icon"}),React.createElement("span",{className:"eva-account-menu__label"},"更换头像")),React.createElement(Dropdown.Item,{className:"eva-account-menu__item",onClick:()=>{evaNavFlyout.close("account");setVisible(true)}},React.createElement(Settings,{size:16,className:"eva-account-menu__icon"}),React.createElement("span",{className:"eva-account-menu__label"},"设置")),React.createElement(Dropdown.Item,{className:"eva-account-menu__item eva-account-menu__item--danger",onClick:()=>{evaNavFlyout.close("account");auth.logout&&auth.logout()}},React.createElement(EvaLogOutIcon,{size:16,className:"eva-account-menu__icon"}),React.createElement("span",{className:"eva-account-menu__label"},"退出登录")))},React.createElement("button",{type:"button",className:classNames("eva-sider-account",menuOpen&&"is-open"),"aria-haspopup":"menu","aria-expanded":menuOpen,"aria-label":"账户："+name},React.createElement("img",{className:"eva-sider-account__avatar",src:window.EvaAvatar.personUri(actorId),alt:""}),React.createElement("span",{className:"eva-sider-account__name","data-eva-tooltip":name,"data-eva-tooltip-clamp":""},name),React.createElement(ChevronRight,{size:16,className:"eva-sider-account__chevron","aria-hidden":true})))),window.EvaSettingsUI.render({visible,onClose:()=>setVisible(false),navigate},{React:reactExports,Modal,Button,icons:{ChevronDown,MessageSquare,general:Settings,appearance:Monitor,engine:SlidersHorizontal,im:Bot,browser:Globe,mail:Mail$1,memory:Brain$8,shortcuts:Keyboard,about:Info$4,usage:createLucideIcon("chart-column",[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16",key:"axes"}],["path",{d:"M18 17V9",key:"bar1"}],["path",{d:"M13 17V5",key:"bar2"}],["path",{d:"M8 17v-3",key:"bar3"}]])},pages:{general:EvaGeneral,appearance:(window.EvaAppearanceUI?window.EvaAppearanceUI.create({React:reactExports}):EvaAppearance),engine:EvaEngine,im:EvaImBot,browser:EvaBrowser,mail:EvaMail,memory:EvaMemory,shortcuts:EvaShortcut,about:EvaAbout}}),avatarOpen&&React.createElement(evaMembers().ui.IdentityCard,{identity:actorId,startAvatarEditing:true,onClose:()=>setAvatarOpen(false)}))},
EvaDigitalLinkIcon=createLucideIcon("link-2",[["path",{d:"M9 17H7A5 5 0 0 1 7 7h2",key:"left"}],["path",{d:"M15 7h2a5 5 0 1 1 0 10h-2",key:"right"}],["path",{d:"M8 12h8",key:"middle"}]]),EvaChevronDownIcon=createLucideIcon("chevron-down",[["path",{d:"m6 9 6 6 6-6",key:"chevron-down"}]]),EvaDigitalEmployeesPage=props=>{const navigate=useNavigate();return window.EvaDigitalEmployeesUI.render({...props,navigate},{React:reactExports,Button,Input:ForwardInput,TextArea,Select,Checkbox,Switch,Modal,Table,Tag,Toast,Dropdown,ChannelsView,icons:{Search:Search$1,More:EllipsisIcon,Sparkles,Users,Grid:LayoutGrid,File:FileText,Link:EvaDigitalLinkIcon,ArrowLeft:ArrowLeft$3,ChevronDown:EvaChevronDownIcon},members:evaMembers().store,navigatePersonal:(id,go)=>go("/guid")})},EvaContactsIcon=createLucideIcon("book-user",[["path",{d:"M15 13a3 3 0 1 0-6 0",key:"book-user-profile"}],["path",{d:"M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20",key:"book-user-book"}],["circle",{cx:"12",cy:"8",r:"2",key:"book-user-avatar"}]]),EvaConnectionCenterIcon=createLucideIcon("cable",[["path",{d:"M17 19a1 1 0 0 1-1-1v-2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a1 1 0 0 1-1 1z",key:"cable-socket"}],["path",{d:"M17 21v-2",key:"cable-socket-pin"}],["path",{d:"M19 14V6.5a1 1 0 0 0-7 0v11a1 1 0 0 1-7 0V10",key:"cable-line"}],["path",{d:"M21 21v-2",key:"cable-socket-pin-2"}],["path",{d:"M3 5V3",key:"cable-plug-pin"}],["path",{d:"M4 10a2 2 0 0 1-2-2V6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2a2 2 0 0 1-2 2z",key:"cable-plug"}],["path",{d:"M7 5V3",key:"cable-plug-pin-2"}]]),EvaDriveIcon=createLucideIcon("hard-drive",[["path",{d:"M10 16h.01",key:"1ra8yu"}],["path",{d:"M2.212 11.577a2 2 0 0 0-.212.896V18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-5.527a2 2 0 0 0-.212-.896L18.55 5.11A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z",key:"1jiv2b"}],["path",{d:"M21.946 12.013H2.054",key:"12xlhc"}],["path",{d:"M6 16h.01",key:"1l4qyb"}]]),EvaWorkbenchIcon=createLucideIcon("presentation",[["path",{d:"M2 3h20",key:"top"}],["path",{d:"M21 3v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V3",key:"screen"}],["path",{d:"m7 21 5-5 5 5",key:"stand"}]]),EvaAutomationIcon=createLucideIcon("alarm-clock",[["circle",{cx:"12",cy:"13",r:"8",key:"face"}],["path",{d:"M12 9v4l2 2",key:"hands"}],["path",{d:"M5 3 2 6",key:"left-bell"}],["path",{d:"m22 6-3-3",key:"right-bell"}],["path",{d:"M6.38 18.7 4 21",key:"left-foot"}],["path",{d:"M17.64 18.67 20 21",key:"right-foot"}]]),
...
EvaNavIcon=(rt,ct,ut)=>React.createElement("span",{className:"eva-nav-icon"},rt,ct&&React.createElement("span",{className:"eva-nav-icon__unread",role:"status","aria-label":ut||"有未读消息"})),EvaMessagesNavEntry=rt=>{const ct=evaMembers().store;reactExports.useSyncExternalStore(ct.subscribe,ct.getSnapshot,ct.getSnapshot);const ut=evaMessagesHasUnread(ct),pt=React.createElement(EvaMessageCircleIcon,{size:16,strokeWidth:1.8,className:"block leading-none"}),gt=EvaNavIcon(pt,ut);return React.createElement(SiderEvaStub,{label:rt.label,isMobile:rt.isMobile,collapsed:rt.isMobile&&rt.collapsed,siderTooltipProps:rt.siderTooltipProps,isActive:rt.isActive,onClick:rt.onClick,icon:gt})},
EvaMyAgentIcon=createLucideIcon("bot-message-square",[["path",{d:"M12 6V2H8",key:"bot-message-square-top"}],["path",{d:"M15 11v2",key:"bot-message-square-eye-r"}],["path",{d:"M2 12h2",key:"bot-message-square-ear-l"}],["path",{d:"M20 12h2",key:"bot-message-square-ear-r"}],["path",{d:"M20 16a2 2 0 0 1-2 2H8.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 4 20.286V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2z",key:"bot-message-square-body"}],["path",{d:"M9 11v2",key:"bot-message-square-eye-l"}]]),EvaAgentMarketIcon=createLucideIcon("store",[["path",{d:"M15 21v-5a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v5",key:"store-door"}],["path",{d:"M17.774 10.31a1.12 1.12 0 0 0-1.549 0 2.5 2.5 0 0 1-3.451 0 1.12 1.12 0 0 0-1.548 0 2.5 2.5 0 0 1-3.452 0 1.12 1.12 0 0 0-1.549 0 2.5 2.5 0 0 1-3.77-3.248l2.889-4.184A2 2 0 0 1 7 2h10a2 2 0 0 1 1.653.873l2.895 4.192a2.5 2.5 0 0 1-3.774 3.244",key:"store-awning"}],["path",{d:"M4 10.95V19a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8.05",key:"store-base"}]]),EvaMyAiCollaborationIcon=()=>{const rt=window.EvaAITeam,ct=window.EvaDigitalEmployeesStore,pt=window.EvaMyAITeamGroup;reactExports.useSyncExternalStore(rt.subscribe,rt.getSnapshot,rt.getSnapshot);reactExports.useSyncExternalStore(ct.subscribe,ct.getSnapshot,ct.getSnapshot);reactExports.useSyncExternalStore(pt.subscribe,pt.getSnapshot,pt.getSnapshot);const ut=rt.hasUnread()||ct.hasUnread()||pt.hasUnread();return EvaNavIcon(React.createElement(EvaMyAgentIcon,{size:16,strokeWidth:1.8,className:"block leading-none","aria-hidden":true}),ut,"我的 Agent 有未读消息")},
        /* EvaSidebarSection 把自身 collapsed 作为第二参传给 render:可见折叠区(true)
         * 用缩写标签,展开侧栏与「更多」弹层(false)一律完整菜单名。 */
        EvaSidebarSection=({title:rt,items:ct,render:ut,collapsed:pt})=>{const mt=rt==="数字员工"?"其他":pt&&rt==="团队协作"?"团队":rt,gt=ct.map(vt=>{const yt=ut(vt,pt);return React.createElement("div",{className:"eva-nav-entry",key:vt,"data-eva-nav-id":vt},yt)});return React.createElement("section",{className:classNames("eva-nav-section",pt&&"is-collapsed"),"aria-label":mt},React.createElement("div",{className:"eva-nav-section__title"},mt),React.createElement("div",{className:"eva-nav-section__items"},gt))},
EvaSidebarNavigation=rt=>{const ct={isMobile:rt.isMobile,collapsed:rt.collapsed,siderTooltipProps:rt.siderTooltipProps},pt=(gt,evaSectionCollapsed)=>{switch(gt){case"search":return React.createElement(SiderSearchEntry,{key:gt,...ct,onConversationSelect:rt.onConversationSelect,onSessionClick:rt.onSessionClick});case"new-chat":return React.createElement(EvaPersonalEntry,{key:gt,...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/guid")});case"workboard":return React.createElement(SiderEvaStub,{key:gt,label:"任务看板",icon:React.createElement(Workbench,{theme:"outline",size:"16",fill:"currentColor",className:"block leading-none",style:{lineHeight:0}}),...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/eva-stub/工作板")});case"automation":return React.createElement(SiderEvaStub,{key:gt,label:evaSectionCollapsed?"自动化":"自动化任务",icon:React.createElement(AlarmClock$4,{theme:"outline",size:"16",fill:"currentColor",className:"block leading-none",style:{lineHeight:0}}),...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/scheduled")});case"messages":return React.createElement(SiderMessagesEntry,{key:gt,...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/messages")});case"my-ai":return React.createElement("div",{key:gt,id:"eva-my-avatar-nav","data-eva-my-avatar-nav":"true"},React.createElement(SiderEvaStub,{label:evaSectionCollapsed?"Agent":"我的 Agent",icon:React.createElement(EvaMyAiCollaborationIcon,null),...ct,isActive:rt.activeNavId===gt,onClick:()=>{}}));case"projects":return React.createElement(SiderCollabEntry,{key:gt,...ct,isActive:rt.activeNavId===gt,onClick:()=>{window.dispatchEvent(new CustomEvent("eva:open-project-directory")),rt.navigate("/collab")}});case"contacts":return React.createElement("div",{key:gt,id:"eva-contacts-nav","data-eva-contacts-nav":"true"},React.createElement(SiderEvaStub,{label:"通讯录",icon:React.createElement(EvaContactsIcon,{size:16,strokeWidth:1.8,className:"block leading-none",style:{lineHeight:0}}),...ct,isActive:rt.activeNavId===gt,onClick:()=>{}}));case"drive":return React.createElement("div",{key:gt,id:"eva-drive-nav","data-eva-action":"drive","data-eva-native-clone":"true"},React.createElement(SiderEvaStub,{label:"文件库",icon:React.createElement(EvaDriveIcon,{size:16,strokeWidth:1.8,className:"block leading-none",style:{lineHeight:0}}),...ct,isActive:rt.activeNavId===gt,onClick:()=>{}}));case"digital-employees":return React.createElement(SiderEvaStub,{key:gt,label:evaSectionCollapsed?"数字员工":"数字员工市场",icon:React.createElement(EvaAgentMarketIcon,{size:16,strokeWidth:1.8,className:"block leading-none","aria-hidden":true}),...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/eva-stub/数字员工?evaMode="+rt.mode)});case"connection-center":return React.createElement("div",{key:gt,id:"eva-connection-center-nav"},React.createElement(SiderEvaStub,{label:"连接中心",icon:React.createElement(EvaConnectionCenterIcon,{size:16,strokeWidth:1.8,className:"block leading-none",style:{lineHeight:0}}),...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/eva-stub/技能?evaMode="+rt.mode)}));case"sites":return React.createElement(SiderEvaStub,{key:gt,label:"站点",icon:React.createElement(Earth$2,{theme:"outline",size:"16",fill:"currentColor",className:"block leading-none",style:{lineHeight:0}}),...ct,isActive:rt.activeNavId===gt,onClick:()=>rt.navigate("/eva-stub/站点?evaMode="+rt.mode)});default:return null}};
        ...
        const moreOpen=reactExports.useSyncExternalStore(evaNavFlyout.subscribe,evaNavFlyout.getSnapshot,evaNavFlyout.getSnapshot)==="more";
...
`;
        ...
        var nativePageComponent = String.raw`EvaContactsPage=()=>window.EvaContactsUI.render({React:reactExports,Button,Input:ForwardInput,Modal,SearchIcon:Search$1,CloseIcon:X,store:evaMembers().store,ui:evaMembers().ui}),EvaSitesPage=()=>window.EvaSitesUI.render({React:reactExports}),EvaNativePage=({pageId:rt,services:ct})=>{const ut=reactExports.useRef(null);reactExports.useEffect(()=>{const pt=ut.current;return window.__evaNativePages?.mount(rt,pt,ct),()=>window.__evaNativePages?.unmount(rt,pt)},[rt,ct]);return React.createElement("div",{ref:ut,id:"eva-native-page-"+rt,className:"eva-native-page-host","data-eva-native-page":rt})},EvaPersonalPage=()=>{const[rt,ct]=reactExports.useState(null),[ut,pt]=reactExports.useState(""),[mt,gt]=reactExports.useState(""),St=reactExports.useCallback(()=>{const Ct=typeof rt?.returnFocus==="function"?rt.returnFocus():rt?.returnFocus;ct(null);pt("");gt("");requestAnimationFrame(()=>{Ct?.isConnected&&Ct.focus()})},[rt]),Ct=reactExports.useCallback(()=>{try{const xt=window.EvaPersonal.createFolder(ut);rt?.onCreated?.(xt);St()}catch(xt){gt(xt?.message||"无法新建分组")}},[ut,rt,St]),xt=reactExports.useMemo(()=>({openCreateFolder:Pt=>{ct(Pt||{});pt("");gt("")}}),[]);reactExports.useEffect(()=>{if(!rt)return;const Pt=requestAnimationFrame(()=>document.getElementById("eva-personal-folder-name")?.focus());return()=>cancelAnimationFrame(Pt)},[rt]);return React.createElement(React.Fragment,null,React.createElement(EvaNativePage,{pageId:"personal",services:xt}),React.createElement(Modal,{className:"eva-members-modal eva-personal-folder-modal",width:420,title:"新建分组",visible:!!rt,onCancel:St,onOk:Ct,okText:"新建",cancelText:"取消",maskClosable:true,closeOnEsc:true,cancelButtonProps:{"aria-label":"取消"},okButtonProps:{disabled:!ut.trim(),"aria-label":"新建"}},React.createElement("div",{className:"eva-members-field"},React.createElement("label",{htmlFor:"eva-personal-folder-name"},"分组名称"),React.createElement(ForwardInput,{id:"eva-personal-folder-name",value:ut,onChange:Pt=>{pt(Pt);gt("")},onEnterPress:Ct,maxLength:60,placeholder:"请输入分组名称",autoFocus:true,"aria-describedby":mt?"eva-personal-folder-error":void 0})),mt&&React.createElement("p",{id:"eva-personal-folder-error",role:"alert",className:"eva-members-error"},mt)))},`;
        source = root.__evaCut(source, nativePageAnchor, nativePageComponent + nativePageAnchor, '原生路由页面宿主');
        source = root.__evaCutAll(source, [
          ['React.createElement(Route,{path:"/guid",element:withRouteFallback(Guid)})', 'React.createElement(Route,{path:"/guid",element:React.createElement(EvaPersonalPage,null)})'],
          ['React.createElement(Route,{path:"/conversation/:id",element:withRouteFallback(Conversation)})', 'React.createElement(Route,{path:"/conversation/:id",element:React.createElement(EvaPersonalPage,null)})'],
          ...
          ['function EvaStubPage(){const{name:rt}=useParams(),ct=decodeURIComponent(rt??"");if(ct==="技能")return React.createElement("div",{id:"eva-connection-center-native-host",className:"eva-connection-center-native-host"});', 'function EvaStubPage(){const{name:rt}=useParams(),ct=decodeURIComponent(rt??"");if(ct==="工作板")return React.createElement(EvaNativePage,{pageId:"workboard"});if(ct==="数字员工")return React.createElement(EvaDigitalEmployeesPage,{view:"market"});if(ct==="站点")return React.createElement(EvaSitesPage,null);if(ct==="技能")return React.createElement(EvaNativePage,{pageId:"connection-center"});']
        ], '正式页面路由');
