...
`;
         ...
         * EvaSidebarNavigation 的响应式收纳：可见区放不下的入口收进底部「更多」，点击以
         * 二级浮层弹出（样式见 012-mode-layer.css .eva-nav-more*）。活动项永不进溢出，
