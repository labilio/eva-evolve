...
EvaMessagesNavEntry=rt=>{const ct=evaMembers().store;reactExports.useSyncExternalStore(ct.subscribe,ct.getSnapshot,ct.getSnapshot);const ut=evaMessagesHasUnread(ct),pt=React.createElement(MessageSquare,{size:16,strokeWidth:1.8,className:"block leading-none"}),mt={label:rt.label,isMobile:rt.isMobile,collapsed:rt.isMobile&&rt.collapsed,siderTooltipProps:rt.siderTooltipProps,isActive:rt.isActive,onClick:rt.onClick};if(rt.collapsed){const gt=React.createElement("span",{className:"eva-nav-msg-iconwrap"},pt,ut&&React.createElement("span",{className:"eva-nav-msg-unread eva-nav-msg-unread--icon",role:"status","aria-label":"有未读消息",title:"有未读消息"}));return React.createElement(SiderEvaStub,{...mt,icon:gt})}return React.createElement("div",{className:"eva-nav-msg"},React.createElement(SiderEvaStub,{...mt,icon:pt}),ut&&React.createElement("span",{className:"eva-nav-msg-unread eva-nav-msg-unread--edge",role:"status","aria-label":"有未读消息",title:"有未读消息"}))},
