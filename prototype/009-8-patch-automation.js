...
`;
  ...
  return React.createElement("div",{className:"eva-automation-page"},React.createElement("header",{className:"eva-page-header"},React.createElement("h1",null,"自动化任务")),React.createElement(EvaSharedAutomationPage,{scope:"personal",items:Nt,loading:pt,onCreate:()=>Ct(true),onOpenRun:Mt=>Pt(Mt),notice:"每次触发都会创建一个新的 Session，并在这里保留运行记录。"}),React.createElement(CreateTaskDialog,{visible:St,onClose:()=>Ct(false)}));
