...
test('查找右栏使用 Eva 组件色并以 380px 右侧浮层覆盖消息区', async () => {
  ...
  assert.deepEqual(styles.slice(-6), ['prototype/055-conversation-search.css', 'prototype/056-heading-system.css', 'prototype/057-gds-dark-tokens.css', 'prototype/060-avatar-editor.css', 'prototype/060-task-drawer.css', 'prototype/061-forward-picker.css']);
});
